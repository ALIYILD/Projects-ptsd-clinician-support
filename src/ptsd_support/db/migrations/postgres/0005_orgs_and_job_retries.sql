...
ALTER TABLE patient_cases ADD COLUMN IF NOT EXISTS organization_key TEXT;
CREATE INDEX IF NOT EXISTS idx_patient_cases_org
ON patient_cases(organization_key, updated_at DESC);

ALTER TABLE job_runs ADD COLUMN IF NOT EXISTS attempt_count INTEGER NOT NULL DEFAULT 0;
ALTER TABLE job_runs ADD COLUMN IF NOT EXISTS max_attempts INTEGER NOT NULL DEFAULT 1;
ALTER TABLE job_runs ADD COLUMN IF NOT EXISTS next_attempt_at TEXT;
